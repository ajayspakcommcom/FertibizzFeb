        ...
        .post('/hospitals-list/', param).then((response) => {
            ...
            lists.forEach(list => {
                ...
                <td>${camelCaseText(list.DoctorName)}</td>
                  <td class="text-center"><a href="./potential-add?cid=${list.customerId}&centreName=${list.CENTRENAME}&drName=${list.DoctorName}"><svg class="isDataSubmitted ${(list.PotentialStatus.toLowerCase() == 'pending')? 'pending': (list.PotentialStatus.toLowerCase() == 'approved') ? 'approved' : (list.PotentialStatus.toLowerCase() == 'rejected') ? 'rejected' : ''}" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 17.35 17.35"><defs></defs><path class="cls-1" d="M8.67,14.22a.45.45,0,0,1-.24-.09c-.1-.06-.19-.14-.19-.42V6.85c0-1.09,0-2.18,0-3.27a.42.42,0,0,1,.42-.45l.17,0c.13,0,.27.15.27.47V13.77a.39.39,0,0,1-.24.39A.41.41,0,0,1,8.67,14.22Z"/><path class="cls-1" d="M3.58,9.11a.39.39,0,0,1-.39-.24.41.41,0,0,1-.06-.2.45.45,0,0,1,.09-.24c0-.08.12-.19.42-.19H13.77a.42.42,0,0,1,.45.42.38.38,0,0,1,0,.17c0,.13-.14.27-.47.27Z"/><path class="cls-1" d="M8.67,17.35a8.68,8.68,0,1,1,8.68-8.68A8.68,8.68,0,0,1,8.67,17.35Zm0-16.5A7.83,7.83,0,1,0,16.5,8.67,7.83,7.83,0,0,0,8.67.85Z"/></svg></a></td>
                  <td class="text-center"><a href="./market-insight-add?insightId=${list.insightId}&centreId=${list.customerId}&centreName=${list.CENTRENAME}&drName=${list.DoctorName}"><svg class="isDataSubmitted" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 17.35 17.35"><defs></defs><path class="cls-1" d="M8.67,14.22a.45.45,0,0,1-.24-.09c-.1-.06-.19-.14-.19-.42V6.85c0-1.09,0-2.18,0-3.27a.42.42,0,0,1,.42-.45l.17,0c.13,0,.27.15.27.47V13.77a.39.39,0,0,1-.24.39A.41.41,0,0,1,8.67,14.22Z"/><path class="cls-1" d="M3.58,9.11a.39.39,0,0,1-.39-.24.41.41,0,0,1-.06-.2.45.45,0,0,1,.09-.24c0-.08.12-.19.42-.19H13.77a.42.42,0,0,1,.45.42.38.38,0,0,1,0,.17c0,.13-.14.27-.47.27Z"/><path class="cls-1" d="M8.67,17.35a8.68,8.68,0,1,1,8.68-8.68A8.68,8.68,0,0,1,8.67,17.35Zm0-16.5A7.83,7.83,0,1,0,16.5,8.67,7.83,7.83,0,0,0,8.67.85Z"/></svg></a></td>
                  <td class="text-center"><a href="./add-business?cid=${list.customerId}&chainAccountType=${list.chainAccountTypeId}&centreName=${list.CENTRENAME}&drName=${list.DoctorName}"><svg class="isDataSubmitted ${(list.BusinessStatus.toLowerCase() == 'pending')? 'pending': (list.BusinessStatus.toLowerCase() == 'approved') ? 'approved' : (list.BusinessStatus.toLowerCase() == 'rejected') ? 'rejected' : ''}" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 17.35 17.35"><defs></defs><path class="cls-1" d="M8.67,14.22a.45.45,0,0,1-.24-.09c-.1-.06-.19-.14-.19-.42V6.85c0-1.09,0-2.18,0-3.27a.42.42,0,0,1,.42-.45l.17,0c.13,0,.27.15.27.47V13.77a.39.39,0,0,1-.24.39A.41.41,0,0,1,8.67,14.22Z"/><path class="cls-1" d="M3.58,9.11a.39.39,0,0,1-.39-.24.41.41,0,0,1-.06-.2.45.45,0,0,1,.09-.24c0-.08.12-.19.42-.19H13.77a.42.42,0,0,1,.45.42.38.38,0,0,1,0,.17c0,.13-.14.27-.47.27Z"/><path class="cls-1" d="M8.67,17.35a8.68,8.68,0,1,1,8.68-8.68A8.68,8.68,0,0,1,8.67,17.35Zm0-16.5A7.83,7.83,0,1,0,16.5,8.67,7.83,7.83,0,0,0,8.67.85Z"/></svg></a></td>
                  <td class="text-center"><a href="./add-competition?cid=${list.customerId}&centreName=${list.CENTRENAME}&drName=${list.DoctorName}"><svg class="isDataSubmitted ${(list.CompetitionStatus.toLowerCase() == 'pending')? 'pending': (list.CompetitionStatus.toLowerCase() == 'approved') ? 'approved' : (list.CompetitionStatus.toLowerCase() == 'rejected') ? 'rejected' : ''}" xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 17.35 17.35"><defs></defs><path class="cls-1" d="M8.67,14.22a.45.45,0,0,1-.24-.09c-.1-.06-.19-.14-.19-.42V6.85c0-1.09,0-2.18,0-3.27a.42.42,0,0,1,.42-.45l.17,0c.13,0,.27.15.27.47V13.77a.39.39,0,0,1-.24.39A.41.41,0,0,1,8.67,14.22Z"/><path class="cls-1" d="M3.58,9.11a.39.39,0,0,1-.39-.24.41.41,0,0,1-.06-.2.45.45,0,0,1,.09-.24c0-.08.12-.19.42-.19H13.77a.42.42,0,0,1,.45.42.38.38,0,0,1,0,.17c0,.13-.14.27-.47.27Z"/><path class="cls-1" d="M8.67,17.35a8.68,8.68,0,1,1,8.68-8.68A8.68,8.68,0,0,1,8.67,17.35Zm0-16.5A7.83,7.83,0,1,0,16.5,8.67,7.83,7.83,0,0,0,8.67.85Z"/></svg></a></td>
